...
namespace FfmpegInterface
{
    public class ffmpeg : CommandLineInterface
    {
        ...
        /// <summary>
        /// Extracts all frames as images.
        /// </summary>
        /// <param name="inputPath"></param>
        /// <param name="outputFolder"></param>
        public void ExtractAllFrames(string inputPath, string outputFolder)
        {
            base.RunCommand("-i", inputPath, Path.Combine(outputFolder, $"{Path.GetFileNameWithoutExtension(inputPath)}_%03d.png"));
        }
    }
}
